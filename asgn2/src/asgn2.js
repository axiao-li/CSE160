...
Non-cube primitive is a cone, which can be found at the end of the otter's tail,
the otter's ears, and the fish the otter holds during the poke animation. The
otter construction and animations are in Otter.js.
